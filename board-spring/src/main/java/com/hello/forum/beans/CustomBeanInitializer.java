...
/**
 * Spring이 기본적으로 생성하는 Bean 이외에
 * 개발자가 직접 만든 클래스의 Bean을 Bean Container에 적재시키는 역할. (ex. FileHandler)
 * 
...
public class CustomBeanInitializer {
	...
	FileHandler fileHandler() {
		// @Bean을 쓸때에는 public 을 쓰지 않는다.
		// public FileHandler fileHandler -> x
		...
		fileHandler.setHandler(fileMimeTypeHandler);
		return fileHandler;
	}
